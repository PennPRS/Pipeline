...
A test runner configuration is provided for users to easily test the pipeline in their local environment. To conduct an automated testing, please follow the instructions on the [test-runner](./test-runner/) page.
</br>
...
./run_all.sh --only 5.1           # run all examples in each section
